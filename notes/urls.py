...
from .views import CreateNoteView, RetrieveNoteView, QueryNotesView, UpdateNoteView,DeleteNoteView
...
urlpatterns = [
    ...
    path('notes/<int:pk>/delete/', DeleteNoteView.as_view(), name='delete-note'),
]
